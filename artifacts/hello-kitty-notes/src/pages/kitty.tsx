    ...
    <div className="space-y-12 pb-20">
      <header className="bg-white p-8 rounded-[3rem] border border-border shadow-sm relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="font-heading text-4xl text-primary drop-shadow-sm mb-3">Talk to Batman</h2>
          <p className="text-muted-foreground font-secondary text-xl font-medium">he actually gets you 🦇</p>
        </div>
